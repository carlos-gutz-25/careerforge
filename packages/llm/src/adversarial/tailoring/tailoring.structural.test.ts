...
describe.each(TAILORING_ADVERSARIAL_CORPUS)('tailoring structural guards: $id', (fixture) => {
...
describe('forged-delimiter tailoring fixture: the real token defeats the forgery', () => {
  const forged = TAILORING_ADVERSARIAL_CORPUS.filter(
...
describe('fresh boundary token per tailoring wire call', () => {
